...
import edu.urfu.project_workshop.neural.util.DownloadUtil;
...
public class MnistClassifier {
    ...
    public static void run() throws Exception {
        ...
        if (DownloadUtil.downloadFile(dataUrl, localFilePath))
            log.debug("Data downloaded from {}", dataUrl);
        if (!new File(basePath + "/mnist_png").exists())
            DownloadUtil.extractTarGz(localFilePath, basePath);
